...
--changeSet abeznos:update_002 logicalFilePath:database/scripts
...
insert into users (login, password, last_name, first_name, middle_name, user_settings_id) values ('q', 'w', 'Гошел' , 'Игорь' , 'Семёнович', 1),
('a', 's', 'Лорина' , 'Ольга' , 'Борисовна', 2),
('z', 'x', 'Доров' , 'Михаил' , 'Викторович', 3);
